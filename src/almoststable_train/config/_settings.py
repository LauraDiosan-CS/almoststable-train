...
class MlflowSettings:
    enabled: bool = False
    tracking_uri: str = ""
    experiment_name: str = "almoststable-train-experiment"
...
class MinioSettings:
    ...
    path: str = "almoststable-train/data.csv"
    user: str | None = None
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        mlflow_settings = MlflowSettings(
            ...
            experiment_name=cls.read_str_from_env("MLFLOW_EXPERIMENT_NAME", "almoststable-train-experiment")
        )
        minio_settings = MinioSettings(
            ...
            path=cls.read_str_from_env("MINIO_OBJECT_PATH", "almoststable-train/data.csv"),
